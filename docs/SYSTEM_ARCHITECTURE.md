...
এই ডকুমেন্টটি **single source of truth** হিসেবে কাজ করবে।

* আজ, কাল, ৫ দিন বা ৫ মাস পর যেকোনো AI agent / developer এই ফাইল পড়েই বুঝবে:

  * কী বানানো হয়েছে
  * কী বাকি আছে
  * নতুন ফিচার যোগ করলে কোথায় যোগ করতে হবে
  * কোন জায়গায় পরিবর্তন করলে conflict হবে

👉 **এই ফাইল না বদলে সরাসরি কোডে বড় পরিবর্তন করা যাবে না**
